        ...
        <div className="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-8 pt-12 lg:pb-4 pb-12">
          <div className="border border-indigo-300 h-[550px] rounded-lg w-full">
            ...
            <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
              ...
              <button
                onClick={() => navigate("/")}
                className="mt-8 bg-indigo-500 text-white rounded-full cursor-pointer leading-6 font-medium text-center shadow-md transition-all duration-500 py-3 px-8 text-base hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
              >
                Return Home
              </button>
              {/* --------------------------- */}
