...
const NotFoundGraphicSVG = () => (
  ...
  >
    {/* Background shape - Light Primary */}
    <path
    ...
    />
    {/* Main Icon Elements - Primary Color */}
    <path
    ...
    <path
      ...
      className="fill-primary"
    />
    <circle cx="136.191" cy="31.0854" r="1.36752" className="fill-primary" />
    <circle cx="141.661" cy="31.0854" r="1.36752" className="fill-primary" />
    <circle cx="147.131" cy="31.0854" r="1.36752" className="fill-primary" />
  </svg>
);
    ...
    <section className="min-h-screen">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-8 pt-12 lg:pb-4 pb-12">
          {/* Changed border-indigo-300 to border-primary/30 */}
          <div className="border border-primary/30 h-[550px] rounded-lg w-full">
            {/* Changed border-indigo-100 to border-primary/10 */}
            <div className="p-8 flex justify-between items-center border-b border-primary/10">
              {/* Dots/Controls SVG container */}
              <div className="block">
                <svg
                  width="204"
                  height="18"
            ...
            <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
              ...
              <div className="block text-center mt-5">
                <h5 className="md:text-xl text-lg leading-8 text-gray-900 font-medium mb-1.5">
                  {/* Changed text-indigo-600 to text-primary */}
              ...
              {/* --- Return Home Button --- */}
              <Button onClick={() => navigate("/")} className="my-4">
                Return Home
              </Button>
              {/* --------------------------- */}
            </div>
